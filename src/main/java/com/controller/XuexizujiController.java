    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(xuexizuji !=null){
            ...
            //级联表 课程
            //级联表
            KechengEntity kecheng = kechengService.selectById(xuexizuji.getKechengId());
            if(kecheng != null){
    ...
    */
    ...
    public R save(@RequestBody XuexizujiEntity xuexizuji, HttpServletRequest request){
        ...
        Wrapper<XuexizujiEntity> queryWrapper = new EntityWrapper<XuexizujiEntity>()
                .eq("kecheng_id", xuexizuji.getKechengId())
    ...
    public R jieshuxuexi(Integer kechengId, HttpServletRequest request){
        Wrapper<XuexizujiEntity> queryWrapper = new EntityWrapper<XuexizujiEntity>()
...
//                            xuexizujiEntity.setKechengId(Integer.valueOf(data.get(0)));   //课程 要改的
...
//            .notIn("xuexizuji_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        XuexizujiEntity xuexizujiEntity = xuexizujiService.selectOne(queryWrapper);
        if(xuexizujiEntity==null){
