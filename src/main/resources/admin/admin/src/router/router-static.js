...
import huanyuan from '@/views/modules/databaseBackup/huanyuan'
    ...
    import xuexizuji from '@/views/modules/xuexizuji/list'
    ...
    import dictionaryXuexizuji from '@/views/modules/dictionaryXuexizuji/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryXuexizuji',
        name: '学习状态',
        component: dictionaryXuexizuji
    }
    ,{
        path: '/config',
        name: '轮播图',
