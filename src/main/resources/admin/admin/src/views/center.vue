  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='学习时长' prop="xuexiNumber">
               <el-input v-model="ruleForm.xuexiNumber"  placeholder='学习时长' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表 教师 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.xuexiNumber)&& 'yonghu'==this.flag){
