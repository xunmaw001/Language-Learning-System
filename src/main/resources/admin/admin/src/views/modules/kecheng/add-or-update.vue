        ...
        <el-form
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengVideo" label="学习视频" prop="kechengVideo">
                        <file-upload
                            tip="点击上传学习视频"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengVideo" label="学习视频" prop="kechengVideo">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="参考价格" prop="kechengOldMoney">
                       <el-input v-model="ruleForm.kechengOldMoney"
                                 placeholder="参考价格" clearable  :readonly="ro.kechengOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
