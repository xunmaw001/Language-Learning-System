    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='kecheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="参考价格" prop="kechengOldMoney">
                        <el-input v-model="kechengForm.kechengOldMoney"
                                  placeholder="参考价格" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="参考价格" prop="kechengOldMoney">
                            <el-input v-model="ruleForm.kechengOldMoney"
                                      placeholder="参考价格" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='kecheng' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="学习时长" prop="xuexiNumber">
                        <el-input v-model="yonghuForm.xuexiNumber"
                                  placeholder="学习时长" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学习时长" prop="xuexiNumber">
                            <el-input v-model="ruleForm.xuexiNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="开始时间" prop="xuexizujiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.xuexizujiTime"
                                type="datetime"
                                placeholder="开始时间"
                                :disabled="ro.xuexizujiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xuexizujiTime" label="开始时间" prop="xuexizujiTime">
                            <span v-html="ruleForm.xuexizujiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学习状态" prop="xuexizujiTypes">
                        <el-select v-model="ruleForm.xuexizujiTypes" :disabled="ro.xuexizujiTypes" placeholder="请选择学习状态">
                            <el-option
                                v-for="(item,index) in xuexizujiTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学习状态" prop="xuexizujiValue">
                        <el-input v-model="ruleForm.xuexizujiValue"
                            placeholder="学习状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xuexizuji_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xuexizujiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xuexizuji/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xuexizujiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
