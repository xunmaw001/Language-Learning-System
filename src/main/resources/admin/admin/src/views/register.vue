    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">语言课学习系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="学习时长" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.xuexiNumber" autocomplete="off" placeholder="学习时长"  />
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // yonghu 中的 学习时长 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.xuexiNumber== null ||this.ruleForm.xuexiNumber== "")){
                            //     this.$message.error("学习时长不能为空");
                            //     return
                            // }
                            // yonghu 中的 假删 判空处理
...
<style lang="scss" scoped>
    ...
    .container {
        ...
        background-image: url(/yuyankexuexixitong/img/back-img-bg.jpg);
