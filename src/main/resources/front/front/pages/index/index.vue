...
<view class="list-box style8"
    ...
    <view v-if="kechengList.length > 0" @tap="onDetailTap('kecheng',kechengList[0].id)"
          class="box box1"
        ...
        <div v-if="true"
             ...
             class="title hide1">{{kechengList[0].kechengName}}</div>
        <image
                ...
                :src="baseUrl+kechengList[0].kechengPhoto">
        </image>
    </view>
    <view class="list-item">
        <view v-if="kechengList.length > 1" @tap="onDetailTap('guodaojia',kechengList[1].id)"
              class="box box2"
            ...
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{kechengList[1].kechengName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+kechengList[1].kechengPhoto">
            </image>
        </view>
        <view v-if="kechengList.length > 2" @tap="onDetailTap('guodaojia',kechengList[2].id)"
              class="box box3"
              :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 2% 20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"32%","borderStyle":"solid","height":"160rpx"}'>
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{kechengList[2].kechengName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+kechengList[2].kechengPhoto">
            </image>
        </view>
        <view v-if="kechengList.length > 3" @tap="onDetailTap('guodaojia',kechengList[3].id)"
              class="box box4"
            ...
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{kechengList[3].kechengName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+kechengList[3].kechengPhoto">
            </image>
        </view>
    </view>
    <view class="list-item">
        <view v-if="kechengList.length > 4" @tap="onDetailTap('guodaojia',kechengList[4].id)"
              class="box box5"
            ...
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{kechengList[4].kechengName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+kechengList[4].kechengPhoto">
            </image>
        </view>
        <view v-if="kechengList.length > 5" @tap="onDetailTap('guodaojia',kechengList[5].id)"
              class="box box6"
            ...
            <div v-if="true"
                 :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,.3)","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"64rpx","fontSize":"28rpx","borderStyle":"solid"}'
                 class="title hide1">{{kechengList[5].kechengName}}</div>
            <image
                    :style='{"padding":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"20rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}'
                    class="list-item-image" mode="aspectFill"
                    :src="baseUrl+kechengList[5].kechengPhoto">
            </image>
        </view>
    </view>
</view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            this.kechengList.forEach(function(item, index) {
                if(item.kechengContent != null && item.kechengContent != "" && item.kechengContent != "null"){
                    item.kechengContent =item.kechengContent.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gi,"");//替换图片
                }
            });
